...
public class NotificationBookingActivity extends AppCompatActivity {
    ...
    private Button mBtnCAcceptBooking;
    private Button mBtnCancelBooking;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnCAcceptBooking = findViewById(R.id.btnAcceptBooking);
        mBtnCancelBooking = findViewById(R.id.btnCancelBooking);
        ...
        mBtnCAcceptBooking.setOnClickListener(new View.OnClickListener() {
            @Override
